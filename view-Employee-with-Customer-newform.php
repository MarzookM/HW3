...
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#newStoreModal">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="">
                    <div class="mb-3">
                        <label for="iid" class="form-label">Customer</label>
                        <?php 
                    ...
                    <div class="mb-3">
                        <label for="cid" class="form-label">ProductID</label>
                        <input type="text" class="form-control" id="pid" name="pid">
                    </div>
                    <div class="mb-3">
                        <label for="Cname" class="form-label">ProductName</label>
                    ...
                    <div class="mb-3">
                        <label for="PPrice" class="form-label">ProductPrice</label>
