<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editStoreModal<?php echo $Customers['StoreID']; ?>">
...
<!-- Modal -->
<div class="modal fade" id="#editStoreModal<?php echo $Customers['StoreID']; ?>" tabindex="-1" aria-labelledby="#editStoreModal<?php echo $Customers['StoreID']; ?>" aria-hidden="true">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="#editStoreModal<?php echo $Customers['StoreID']; ?>">Edit Store</h1>
            ...
            <div class="modal-body">
                <form method="post" action="">
                    <div class="mb-3">
                        <label for="iid<?php echo $Customers['StoreID'];?>" class="form-label">CustomerID</label>
                        <input type="text" class="form-control" id="iid<?php echo $Customers['StoreID']; ?>" name="iid" value="<?php echo $Customers['StoreID']; ?>">
                    ...
                    <div class="mb-3">
                        <label for="cid<?php echo $Customers['StoreID']; ?>" class="form-label">ProductID</label>
                        <input type="text" class="form-control" id="cid<?php echo $Customers['StoreID'];  ?>" name="cid" value="<?php echo $Customers['StoreID'];  ?>">
                    ...
                    <div class="mb-3">
                        <label for="PName<?php echo $Customers['StoreID'];  ?>" class="form-label">ProductName</label>
                        <input type="text" class="form-control" id="PName<?php echo $Customers['StoreID']; ?>" name="PName" value="<?php echo $Customers['StoreID'];?>">
                    ...
                    <div class="mb-3">
                        <label for="iid<?php echo $Customers['StoreID']; ?>" class="form-label">Customer</label>
                    ...
                    <input type="hidden" name="iid" value="<?php echo $Customers['StoreID'];?>">
